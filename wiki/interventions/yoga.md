...
Hatha-style postures and pranayama, typically delivered gently and at low intensity for LC patients (often supine / restorative work, not flow). On the podcast it almost always shows up in **combination with breathwork** rather than as standalone exercise — the line between "yoga for LC" and "breathwork" is fuzzy.

Distinguish this from **vinyasa flow / hot yoga** which are physically demanding and risk PEM in this population.

## Evidence log

| Ep | Speaker | Role | Outcome | Indication | Notes |
|---:|---|---|---|---|---|
| #2 | [[jackie-baxter]] | patient | helped_partial | breathing-pattern-disorder, anxiety | Wibbs Coulson's online long-covid yoga class. Helped breathing and anxiety; no effect on fatigue at six weeks in. |
| #3 | [[chiara-berardelli]] | patient | helped_partial | pain, mental-health | Daily 15–20-minute "yoga for headaches" videos for several months at her worst. Sense of doing-something + "voice of self-compassion every day". |
| #53 | [[deepak-ravindran]] | clinician (pain specialist) | recommended | pain, dysautonomia | Listed as a core mind-body intervention for nociplastic LC pain — calms immune + nervous system. PEM caution: gentle, restorative styles only. |
...
- [[085-fiona-agombar-yoga-therapy]]
- [[089-gina-short-recovery]]
- [[fiona-agombar]]
- [[suzy-bolt-recovery]]
